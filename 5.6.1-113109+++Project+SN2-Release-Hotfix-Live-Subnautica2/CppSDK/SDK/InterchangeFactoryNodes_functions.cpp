...
// Function InterchangeFactoryNodes.InterchangeTextureFactoryNode.SetCustomMultipleOfFourMode
// (Final, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// const uint8&                            AttributeValue                                         (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    bAddApplyDelegate                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool UInterchangeTextureFactoryNode::SetCustomMultipleOfFourMode(const uint8& AttributeValue, bool bAddApplyDelegate)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("InterchangeTextureFactoryNode", "SetCustomMultipleOfFourMode");

	Params::InterchangeTextureFactoryNode_SetCustomMultipleOfFourMode Parms{};
...
// Function InterchangeFactoryNodes.InterchangeTextureFactoryNode.GetCustomMultipleOfFourMode
// (Final, Native, Public, HasOutParams, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// uint8*                                  AttributeValue                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UInterchangeTextureFactoryNode::GetCustomMultipleOfFourMode(uint8* AttributeValue) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("InterchangeTextureFactoryNode", "GetCustomMultipleOfFourMode");

	Params::InterchangeTextureFactoryNode_GetCustomMultipleOfFourMode Parms{};
