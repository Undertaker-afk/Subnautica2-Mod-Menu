...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// TSubclassOf<class UCommonTextScrollStyle>NewScrollStyle                                         (Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCommonTextBlock::SetScrollStyle(TSubclassOf<class UCommonTextScrollStyle> NewScrollStyle)
{
	static class UFunction* Func = nullptr;
	...
	Parms.NewScrollStyle = NewScrollStyle;
...
// Function CommonUI.CommonTextBlock.StartScrolling
// (Final, RequiredAPI, Native, Public, BlueprintCallable)

void UCommonTextBlock::StartScrolling()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonTextBlock", "StartScrolling");
...
// Function CommonUI.CommonHardwareVisibilityBorder.SetVisibilityQuery
// (Final, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// const struct FGameplayTagQuery&         NewQuery                                               (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UCommonHardwareVisibilityBorder::SetVisibilityQuery(const struct FGameplayTagQuery& NewQuery)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonHardwareVisibilityBorder", "SetVisibilityQuery");

	Params::CommonHardwareVisibilityBorder_SetVisibilityQuery Parms{};

	Parms.NewQuery = std::move(NewQuery);
