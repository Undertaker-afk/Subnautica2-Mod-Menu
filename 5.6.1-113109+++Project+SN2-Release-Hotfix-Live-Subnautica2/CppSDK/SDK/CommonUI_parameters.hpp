...
{
public:
	TSubclassOf<class UCommonTextScrollStyle>     NewScrollStyle;                                    // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct CommonHardwareVisibilityBorder_SetVisibilityQuery final
{
public:
	struct FGameplayTagQuery                      NewQuery;                                          // 0x0000(0x0048)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_CommonHardwareVisibilityBorder_SetVisibilityQuery;
