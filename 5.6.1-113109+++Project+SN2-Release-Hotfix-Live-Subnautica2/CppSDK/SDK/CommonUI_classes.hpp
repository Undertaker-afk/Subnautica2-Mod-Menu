...
public:
	...
	bool                                          bIgnoreFontScaling;                                // 0x0341(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	void SetScrollStyle(TSubclassOf<class UCommonTextScrollStyle> NewScrollStyle);
...
public:
	void SetVisibilityQuery(const struct FGameplayTagQuery& NewQuery);
...
public:
	...
	TSoftObjectPtr<class UCurveFloat>             LargeTextFontSizeMultiplierCurve;                  // 0x00C0(0x0028)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_E8[0x28];                                      // 0x00E8(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                DefaultImageResourceObjectInstance;                // 0x0110(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	class UMaterialInterface*                     DefaultThrobberMaterialInstance;                   // 0x0118(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	struct FSlateBrush                            DefaultThrobberBrush;                              // 0x0120(0x00B0)(Transient, NativeAccessSpecifierPrivate)
	class UCommonUIRichTextData*                  RichTextDataInstance;                              // 0x01D0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
