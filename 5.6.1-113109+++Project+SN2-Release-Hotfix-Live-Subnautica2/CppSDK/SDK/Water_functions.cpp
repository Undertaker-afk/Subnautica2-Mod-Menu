...
// Function Water.WaterWavesBase.UWERecomputeWaves
// (Native, Public, BlueprintCallable)

void UWaterWavesBase::UWERecomputeWaves()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WaterWavesBase", "UWERecomputeWaves");
...
// Function Water.WaterBodyComponent.GetWaterLODMaterialInstances
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// int32                                   InLOD                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UMaterialInstanceDynamic*         ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class UMaterialInstanceDynamic* UWaterBodyComponent::GetWaterLODMaterialInstances(int32 InLOD)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WaterBodyComponent", "GetWaterLODMaterialInstances");

	Params::WaterBodyComponent_GetWaterLODMaterialInstances Parms{};
...
// Function Water.WaterBodyComponent.GetWaveHeightAtPosition
...
// float                                   InWaterDepth                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
float UWaterBodyComponent::GetWaveHeightAtPosition(const struct FVector& InPosition, float InWaterDepth, float InTime, struct FVector* OutNormal) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WaterBodyComponent", "GetWaveHeightAtPosition");

	Params::WaterBodyComponent_GetWaveHeightAtPosition Parms{};
