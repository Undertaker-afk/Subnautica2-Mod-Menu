...
{
public:
	uint8                                         Pad_1C0[0x2B0];                                    // 0x01C0(0x02B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool SetCustomMultipleOfFourMode(const uint8& AttributeValue, bool bAddApplyDelegate);
	...
	bool GetCustomMultipleOfFourMode(uint8* AttributeValue) const;
...
{
public:
	uint8                                         Pad_470[0x98];                                     // 0x0470(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
