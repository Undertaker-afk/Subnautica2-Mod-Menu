...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0CD15500;
	constexpr int32 AppendString      = 0x0147A060;
	constexpr int32 GNames            = 0x0CC31300;
	constexpr int32 GWorld            = 0x0C9D9A20;
	constexpr int32 ProcessEvent      = 0x016B9C20;
